...
interface IDonationMinerV2 {
    ...
    function againstPeriodsDonations() external view returns (uint256);
    function donorLastClaimRewardPeriod(address _donor) external view returns (uint256);
    ...
    function updateAgainstPeriodsDonations(
        uint256 _newAgainstPeriodsDonations
    ) external;
